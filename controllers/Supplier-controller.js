...
const updateSupplier = async (req, res, next) => {
	...
	try {
		...
		if (upSupplier.product_name != product_name)
			upSupplier.product_name = product_name;

		if (upSupplier.product_price != product_price)
			upSupplier.product_price = product_price;
		
		if (upSupplier.br_number != br_number)
			upSupplier.br_number = br_number;
